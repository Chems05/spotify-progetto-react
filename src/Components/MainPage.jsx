...
import MusicSection from "./MusicPart";
      ...
      <main className="col-12 col-md-9 offset-md-3 mainPage">
        ...
        <div className="row">
          <div className="col-10 text-white">
            ...
            {artistName ? (
              <SearchResults artistName={artistName} />
            ) : (
        ...
        <div className="row">
          <div className="col-10 text-white">
            ...
            {artistName ? null : (
              <MusicSection
                artistName={artistName || "katyperry"}
                sectionId="popSection"
              />
            )}
          </div>
        </div>
        <div className="row">
          <div className="col-10 text-white">
            ...
            {artistName ? null : (
              <MusicSection
                artistName={artistName || "eminem"}
                sectionId="hipHopSection"
              />
            )}
          </div>
        </div>
